...
PRIVATE_CHANNEL_ID = -100123456789  # Maxfiy kanal ID SI
# ----------------------------------------------------------------------
...
# --- RENDER PORTINI ESHITISH UCHUN SOKTA WEB SERVER ---
...
# Bot va serverni birgalikda yurgizish
async def main():
    logging.basicConfig(level=logging.INFO)
    await start_web_server()  # Render portini faollashtirish
